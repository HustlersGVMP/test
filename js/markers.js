  L.marker([-1171.5, 3826], {icon: cardMarker}).addTo(map)
  ...
  L.marker([-1431, 3572.5], {icon: cardMarker}).addTo(map)
    .bindPopup("ATM in front of Tattoo Parlor<br><a href='https://content.rockstarnews.ru/up/images/4f61e86d6cec09cb930c918958dc4aa9.png' data-lightbox='image-2' data-title='ATM in front of Tattoo Parlor'>Open In-Game Screenshot</a>");
  L.marker([-1851, 3266], {icon: cardMarker}).addTo(map)
    .bindPopup("Bottom cable car station<br><a href='https://content.rockstarnews.ru/up/images/b653775d1b243ce144d3f63ae8947b0e.png' data-lightbox='image-3' data-title='Bottom cable car station'>Open In-Game Screenshot</a>");
  L.marker([-2104, 2713.5], {icon: cardMarker}).addTo(map)
    .bindPopup("Paleto Cove (Dock)<br><a href='https://content.rockstarnews.ru/up/images/7854e651af678840be1572318c4929ad.jpg' data-lightbox='image-4' data-title='Paleto Cove (Dock)'>Open In-Game Screenshot</a>");
  L.marker([-1310.5, 4978.75], {icon: cardMarker}).addTo(map)
    .bindPopup("Senora Freeway (Most Northern Convenience Store)<br><a href='https://content.rockstarnews.ru/up/images/04d1cfb4d2afbdc2d9f7decf9ec5fadc.png' data-lightbox='image-5' data-title='Senora Freeway (Most Northern Convenience Store)'>Open In-Game Screenshot</a>");
  L.marker([-2030.5, 5687], {icon: cardMarker}).addTo(map)
    .bindPopup("Mount Gordo (Dirt trail up Mt Gordo)<br><a href='https://content.rockstarnews.ru/up/images/d443cf984f9d2eb8b3082ee390ecd1c6.jpg' data-lightbox='image-6' data-title='Mount Gordo (Dirt trail up Mt Gordo)'>Open In-Game Screenshot</a>");
  L.marker([-2291, 4878], {icon: cardMarker}).addTo(map)
    .bindPopup("Grapeseed (Convenience Store)<br><a href='https://content.rockstarnews.ru/up/images/fd60cf0449ffc6bbb73f5ccec3deb18d.jpg' data-lightbox='image-7' data-title='Grapeseed (Convenience Store)'>Open In-Game Screenshot</a>");
  L.marker([-2384.5, 5159], {icon: cardMarker}).addTo(map)
    .bindPopup("McKenzie Field<br><a href='https://content.rockstarnews.ru/up/images/2995a36d5c48db5f23c942f9952569bb.jpg' data-lightbox='image-8' data-title='McKenzie Field'>Open In-Game Screenshot</a>");
  L.marker([-2688, 5536.5], {icon: cardMarker}).addTo(map)
    .bindPopup("Grapeseed (Next to road connecting Grapeseed and Sandy Shores)<br><a href='https://content.rockstarnews.ru/up/images/e7a80148ef1f5413ff1be162a1a4566f.png' data-lightbox='image-9' data-title='Grapeseed (Next to road connecting Grapeseed and Sandy Shores)'>Open In-Game Screenshot</a>");
  L.marker([-2523, 6187], {icon: cardMarker}).addTo(map)
    .bindPopup("San Chianski Mt. Range (Houses at Cape Catfish)<br><a href='https://content.rockstarnews.ru/up/images/7f0c7b78004ecb8e087d4864ea5bbd39.jpg' data-lightbox='image-10' data-title='San Chianski Mt. Range (Houses at Cape Catfish)'>Open In-Game Screenshot</a>");
  L.marker([-2770, 4233], {icon: cardMarker}).addTo(map)
    .bindPopup("Alamo Sea (Pier)<br><a href='https://content.rockstarnews.ru/up/images/622bda9140eed9cce97932100670d268.jpg' data-lightbox='image-11' data-title='Alamo Sea (Pier)'>Open In-Game Screenshot</a>");
  L.marker([-2773, 3386.5], {icon: cardMarker}).addTo(map)
    .bindPopup("Raton Canyon (Lookout Post)<br><a href='https://content.rockstarnews.ru/up/images/95500c59962e3784ac0ebe79cfee0e9c.jpg' data-lightbox='image-11' data-title='Raton Canyon (Lookout Post)'>Open In-Game Screenshot</a>");
  L.marker([-3088.25, 3809.5], {icon: cardMarker}).addTo(map)
    .bindPopup("Stab City (Lost Hangout)<br><a href='https://content.rockstarnews.ru/up/images/d370acd7a95f61953c65ab7c5f88e1bc.jpg' data-lightbox='image-11' data-title='Stab City (Lost Hangout)'>Open In-Game Screenshot</a>");
  L.marker([-3176, 4351], {icon: cardMarker}).addTo(map)
    .bindPopup("Grand Senora Desert (On the side of a road)<br><a href='https://content.rockstarnews.ru/up/images/7e9ba3967c403c7b2a4fbcdcaf5f20da.jpg' data-lightbox='image-11' data-title='Grand Senora Desert (On the side of a road)'>Open In-Game Screenshot</a>");
  L.marker([-3165.75, 4873], {icon: cardMarker}).addTo(map)
    .bindPopup("Sandy Shores Fire Station<br><a href='https://content.rockstarnews.ru/up/images/432f08f0adae6a04e1b27a267726872b.jpg' data-lightbox='image-11' data-title='Sandy Shores Fire Station'>Open In-Game Screenshot</a>");
  L.marker([-3249.5, 5568.5], {icon: cardMarker}).addTo(map)
    .bindPopup("Senora Freeway (YouTool hardware store)<br><a href='https://content.rockstarnews.ru/up/images/f03d8317660986ab01b4cfc59e03f872.png' data-lightbox='image-11' data-title='Senora Freeway (YouTool hardware store)'>Open In-Game Screenshot</a>");
  L.marker([-3524.5, 5071.5], {icon: cardMarker}).addTo(map)
    .bindPopup("Yellow Jack Bar<br><a href='https://content.rockstarnews.ru/up/images/4cefa6c429608d139827d9671b1a3cfc.jpg' data-lightbox='image-11' data-title='Yellow Jack Bar'>Open In-Game Screenshot</a>");
  L.marker([-3839, 5299.5], {icon: cardMarker}).addTo(map)
    .bindPopup("Grand Senora Desert Trailer Park<br><a href='https://content.rockstarnews.ru/up/images/c321c16b535ba788525acdc91770f705.jpg' data-lightbox='image-11' data-title='Grand Senora Desert Trailer Park'>Open In-Game Screenshot</a>");
  L.marker([-3871.25, 4240.5], {icon: cardMarker}).addTo(map)
    .bindPopup("Grand Senora Desert (Rebel Radio station)<br><a href='https://content.rockstarnews.ru/up/images/6f9d9a486e004a27d7120efa2a4202e3.png' data-lightbox='image-11' data-title='Grand Senora Desert (Rebel Radio station)'>Open In-Game Screenshot</a>");
  L.marker([-3500, 3879.5], {icon: cardMarker}).addTo(map)
    .bindPopup("Grand Senora Desert (Near house by Industrial Plant)<br><a href='https://content.rockstarnews.ru/up/images/9fcfe06ba99dfc79fb60b7fe9832299d.png' data-lightbox='image-11' data-title='Grand Senora Desert (Near house by Industrial Plant)'>Open In-Game Screenshot</a>");
  L.marker([-3862, 3575], {icon: cardMarker}).addTo(map)
    .bindPopup("Great Chaparral (House south of the Route 68 Church)<br><a href='https://content.rockstarnews.ru/up/images/c6bdd775892ac79bcc9ce1538214d34b.png' data-lightbox='image-11' data-title='Great Chaparral (House south of the Route 68 Church)'>Open In-Game Screenshot</a>");
  L.marker([-3744, 3032], {icon: cardMarker}).addTo(map)
    .bindPopup("Zancudo (Discount Store)<br><a href='https://content.rockstarnews.ru/up/images/d5d9c83e1d64ca67ee5f4ec05dbeb138.jpg' data-lightbox='image-11' data-title='Zancudo (Discount Store)'>Open In-Game Screenshot</a>");
  L.marker([-3298.5, 2241.75], {icon: cardMarker}).addTo(map)
